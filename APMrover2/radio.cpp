...
{
    channel_steer      = RC_Channel::rc_channel(rcmap.yaw()-1);
    channel_throttle   = RC_Channel::rc_channel(rcmap.throttle()-1);
    channel_learn      = RC_Channel::rc_channel(g.learn_channel-1);
//    channel_steer_d    = RC_Channel::rc_channel(6);
//    channel_throttle_d = RC_Channel::rc_channel(7);
    channel_throttle_dir   = RC_Channel::rc_channel(rcmap.roll()-1);
    channel_steer_dir   = RC_Channel::rc_channel(rcmap.pitch()-1);



	// set rc channel ranges
	channel_steer->set_angle(SERVO_MAX);
	channel_throttle->set_angle(SERVO_MAX);
//	channel_steer_d->set_angle(SERVO_MAX);
//	channel_throttle_d->set_angle(SERVO_MAX);
	channel_throttle_dir->set_angle(SERVO_MAX);
	channel_steer_dir->set_angle(SERVO_MAX);
