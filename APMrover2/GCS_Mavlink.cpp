...
//void Rover::send_boat_status(mavlink_channel_t chan)
//{
//    if(ctrl_FB_update_flag == true || camera_FB_update_flag == true ){
//        mavlink_msg_nav_controller_output_send(chan, control_feedback,camera_feedback );
//
...
//    case MSG_BOAT_STATUS:
//        CHECK_PAYLOAD_SIZE(BOAT_STATUS);
//        rover.send_boat_status(chan);
