...
public:
    ...
    // read channel
    static int8_t read_ch_radio(int8_t ch)
    {
        return _aux_channels[ch]->radio_in;
    }

//    // read channel
//    static int8_t read_ch_servo(int8_t ch)
//    {
//        return _aux_channels[ch]->servo_out;
//    }
//
//    // read channel
//    static int8_t read_ch_pwm_in(int8_t ch)
//    {
//        return _aux_channels[ch]->control_in;
//    }
