...
//    rc_8.set_range(0,1000);
      ...
      rc_1.set_range(1000,1500);

      rc_2.set_range(1000,1500);

      rc_3.set_range(1000,1500);

      rc_4.set_range(1000,1500);

      rc_5.set_range(1000,1500);

      rc_6.set_range(1000,1500);

      rc_7.set_range(1000,1500);

      rc_8.set_range(1000,1500);
...
{
    for (int i=0; i<NUM_CHANNELS; i++) {
	    hal.console->printf("cich%u: %4d ", (unsigned)i+1, (int)rc[i].control_in);
    }
    hal.console->printf("\n");

    for (int i=0; i<NUM_CHANNELS; i++) {
        hal.console->printf("poch%u: %4d ", (unsigned)i+1, (int)rc[i].pwm_out);
    }
    hal.console->printf("\n");
}
